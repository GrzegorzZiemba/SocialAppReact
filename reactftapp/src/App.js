	...
	return (
		<div style={{ display: "flex", flexWrap: "nowrap" }}>
			...
			<div>
				...
				text. All the Lorem Ipsum gener What is Lorem Ipsum? Lorem Ipsum is
				...
				gener What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the
				...
				embarrassing hidden in the middle of text. All the Lorem Ipsum gener
				What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing
				and typesetting industry. Lorem Ipsum has been the industry's standard
				dummy text ever since the 1500s, when an unknown printer took a galley
				of type and scrambled it to make a type specimen book. It has survived
				...
				believable. If you are going to use a passage of Lorem Ipsum, you need
				to be sure there isn't anything embarrassing hidden in the middle of
				text. All the Lorem Ipsum gener
			</div>
		</div>
	);
}
